...
const AccessibilityButton: React.FC = () => {
  return (
    ...
    >
      ...
      <div className="w-5 h-5 md:w-8 md:h-8 bg-blue-600 rounded-full flex items-center justify-center text-white shrink-0 shadow-xs">
        <svg 
      ...
      <span className="text-[11px] md:text-sm font-bold text-white whitespace-nowrap pl-0.5 md:pl-1">
        נגישות
      </span>
    </Link>
  );
