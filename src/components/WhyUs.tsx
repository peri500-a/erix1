  ...
  const features = [
    {
      ...
      title: 'צוות הנדסי אורגני',
      description: 'אנו לא מעסיקים פרילנסרים. כל מהנדס באריקס ביקורת מבנים הוא חלק מצוות הליבה שלנו, מה שמבטיח אחריות אישית מלאה וסטנדרט מקצועי אחיד.',
    },
    {
      ...
      title: 'דוחות הנדסיים מפורטים',
      description: 'חוות דעת הנדסית יסודית הנתפרת אישית לכל נכס. אנו נמנעים מתבניות מוכנות ומבטיחים הצגת עובדות מדויקת וחד משמעית לכל ליקוי.',
    },
    {
      ...
      title: 'טכנולוגיה תרמית (FLIR)',
      description: 'שימוש במצלמות תרמיות ומכשור אקוסטי דיגיטלי מהמתקדמים בעולם לאיתור כשלי איטום ורטיבות מבלי לגרום נזק לנכס.',
    },
    {
      ...
      title: 'ליווי וייעוץ אישי',
      description: 'קשר ישיר מול המהנדס המבצע בכל שלב בתהליך. אנו זמינים לכל שאלה מקצועית עד להבטחת מסירה תקינה וביטחון מלא.',
    },
  ];
