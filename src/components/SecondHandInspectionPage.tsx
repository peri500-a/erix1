        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10 text-right">
          <div className="max-w-4xl">
            ...
            <p className="text-lg md:text-xl text-slate-300 leading-relaxed mb-8 max-w-3xl">
              הזמן האידיאלי לבדק בית הוא <strong>אחרי</strong> שהגעתם להסכמה ראשונית על מחיר עם המוכר, אך <strong>לפני</strong> החתימה על חוזה מכר מחייב. בשלב הזה, ממצאי הדוח עדיין יכולים לשמש אתכם במשא ומתן - לדרוש הפחתת מחיר, לתקן ליקויים כתנאי להשלמת העסקה, ובמקרים חריגים אף לסגת מהעסקה. חתימה על חוזה לפני ביצוע הבדיקה משמעה ויתור על נקודת המיקוח המשמעותית ביותר שיש לכם כרוכשים.
            </p>
      ...
      <section className="py-16 bg-slate-50">
        <div className="max-w-5xl mx-auto px-6">
          <div className="bg-white p-8 sm:p-12 rounded-3xl border border-slate-200/80 shadow-sm text-right space-y-10">
            ...
            <div className="border-r-4 border-blue-600 pr-5 py-2 space-y-4">
              <p className="text-slate-800 text-lg md:text-xl leading-relaxed font-medium">
                דירת יד שנייה לא נהנית מאחריות יצרן — ברגע שחתמתם על החוזה, כל ליקוי שיתגלה הוא באחריותכם המלאה. לפני שאתם משקיעים את חסכונות חייכם בנכס, כדאי לדעת בדיוק מה אתם קונים. אריקס ביקורת מבנים מבצעת בדיקה מקיפה בהתאם לתקן הישראלי בהובלת אינג&apos; יוסי פרי, מהנדס בניין רשוי עם מעל 30 שנות ניסיון ו-10,000+ בדיקות. באמצעות מצלמה תרמית, פרוטימטרים מסוגים שונים ומכשור דיגיטלי משוכלל, אנו חושפים רטיבות, בעיות שלד וליקויים סמויים שאינם נראים לעין הבלתי מזוינת — ומספקים לכם דוח הנדסי מפורט וקביל בבית משפט, מצוידים בכל המידע הדרוש למשא-ומתן מבוסס עובדות שתוצאותיו טובות יותר.
              </p>
              <p className="text-blue-600 font-bold text-lg md:text-xl pt-2">
                אל תסמכו רק על מה שרואים בעין. קבעו עכשיו שיחת ייעוץ הנדסי חינם ותדעו בדיוק על מה אתם חותמים.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-slate-50 p-6 sm:p-8 rounded-2xl border border-slate-100 space-y-3">
                ...
                <p className="text-slate-700 text-base leading-relaxed">
                  הבדיקות כוללות: בדיקת רטיבות, בדיקת איטום, בדיקת צנרת האינסטלציה, לחץ מים וספיקה, בדיקת שיפועי ריצוף, בדיקת סדקים וחוסן מבני, בדיקה חשמלית מסוג הארקה (ללא בדיקת בידוד חשמלי מסוג מגר), בדיקת כשירות מערכת מיזוג האוויר, תקינות דלתות, חלונות, תריסים ומעקות. ככל שימצאו ליקויים יירשם אומדן עלויות לליקויים המתגלים.
                </p>
              </div>
