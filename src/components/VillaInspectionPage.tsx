          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              <h2 className="text-3xl md:text-4xl font-black text-slate-900 leading-tight">
                ההשלכות של ליקויי בנייה שלא נבדקו בבית פרטי
              </h2>
              <p className="text-slate-600 text-base leading-relaxed">
                בעוד שדירה קלאסית בבניין נהנית מתמיכת תשתית משותפת ורפד של קומות נוספות, בית פרטי בא במגע ישיר וקריטי מול הקרקע והטבע. כשלים הקשורים בחדירת מי תהום מהיסודות, שקיעת אדמה המעוותת את עמודי השלד או חדירת מי גשמים מגג הרעפים הן בעיות המחמירות במהירות הבזק ומחייבות פתרונות קונסטרוקציה יקרים ביותר.
              </p>
              <p className="text-slate-600 text-base leading-relaxed">
                רכישת בית פרטי ללא ביקורת מומחה פירושה לקיחת סיכון כספי עצום. דוח הליקויים של אריקס ביקורת מבנים מספק לכם שקט נפשי מלא, הגנה משפטית איתנה, והנחות כספיות משמעותיות בשווי העסקה בשלב המשא ומתן.
              </p>
              <div className="p-6 bg-slate-50 border border-slate-100 rounded-2xl">
                <h4 className="font-bold text-slate-900 mb-1 text-base">חוות דעת קונסטרוקטור הכוללת פתרונות הסדרה חוקיים</h4>
                <p className="text-slate-500 text-xs leading-relaxed">
                  אם בדיקת הבית מעלה חריגות בנייה קשות, המהנדס שלנו לא רק מציין אותן בדוח, אלא משרטט עבורכם את מפת הדרכים היעילה, המהירה והחסכונית ביותר לצורך לגליזציה והסדרה חוקית של המבנה מול הוועדה לתכנון ובנייה.
                </p>
              </div>
            </div>
