      ...
      <div className="container mx-auto px-6 relative z-10 w-full max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-right relative z-20">
            ...
            <div className="text-slate-700 text-sm sm:text-base space-y-3 font-medium max-w-2xl leading-relaxed">
              <p>
                עומדים לפני רכישת דירת יד שנייה, קבלת דירה חדשה מקבלן, או זקוקים לחוות דעת מהנדס קבילה בבית משפט? אריקס ביקורת מבנים מלווה אתכם עם מעל 30 שנות ניסיון הנדסי ו-10,000+ בדיקות מוצלחות ברחבי הארץ.
              </p>
              <p>
                כל דוח נכתב ונחתם אישית ע&quot;י אינג&apos; יוסי פרי, מהנדס בניין רשוי — לא צוות פרילנסרים משתנה — כך שאתם מקבלים אחריות אישית מלאה לאורך כל התהליך.
              </p>
              <p>
                באמצעות מצלמות תרמיות FLIR ומכשור אקוסטי דיגיטלי, אנו מאתרים ליקויים סמויים, רטיבות וכשלי בנייה לפני שהם הופכים להפתעה יקרה — ומספקים לכם דוח הנדסי מפורט, קביל במלואו בבית משפט, שמעניק לכם כוח מיקוח אמיתי מול הקבלן או המוכר.
              </p>
            </div>
