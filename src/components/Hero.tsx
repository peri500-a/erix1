    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10 w-full max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 relative px-4 lg:px-0 flex justify-center lg:justify-end lg:-mr-16 xl:-mr-28 z-10">
            <motion.div 
              initial={{ opacity: 0, scale: 0.96 }}
              animate={{ opacity: 1, scale: 1 }}
              transition={{ duration: 1, ease: "easeOut" }}
              className="relative w-full max-w-[420px] lg:max-w-[530px]"
            >
              ...
              {/* Main Image Frame */}
              <div className="relative rounded-[2.5rem] border-[12px] border-white shadow-2xl overflow-hidden aspect-[4/5] bg-white">
                <Image 
