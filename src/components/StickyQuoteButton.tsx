    ...
    <>
      ...
      >
        ...
        <a
          ...
          aria-label="התקשרו אלינו למספר 054-7515142"
          className="flex-1 bg-blue-600 hover:bg-blue-500 text-white font-black py-4 px-4 rounded-2xl shadow-xl flex items-center justify-center gap-2 text-base active:scale-95 transition-all outline-none focus:ring-4 focus:ring-blue-400"
        >
        ...
        <a
          ...
          aria-label="פנייה בוואטסאפ לאריקס ביקורת מבנים"
          className="flex-1 bg-green-600 hover:bg-green-500 text-white font-black py-4 px-4 rounded-2xl shadow-xl flex items-center justify-center gap-2 text-base active:scale-95 transition-all outline-none focus:ring-4 focus:ring-green-400"
        >
