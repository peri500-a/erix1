...
const WhatsAppButton: React.FC = () => {
  return (
    <a 
      ...
      className="hidden md:flex fixed md:bottom-10 md:left-10 z-50 group items-center gap-3 focus:outline-none focus:ring-4 focus:ring-[#25D366]/50 rounded-full"
      aria-label="פנייה מהירה בוואטסאפ לאריקס ביקורת מבנים"
    >
      ...
      <div className="w-14 h-14 md:w-16 md:h-16 bg-[#25D366] rounded-full flex items-center justify-center text-white shadow-[0_10px_30px_rgba(37,211,102,0.4)] hover:scale-110 group-focus:scale-110 group-focus:ring-4 group-focus:ring-[#25D366]/50 transition-all duration-300">
