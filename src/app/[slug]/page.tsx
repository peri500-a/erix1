...
const metadataMapping: Record<string, { title: string; description: string; keywords?: string[] }> = {
  'בדק-בית-בתל-אביב': {
    title: 'בדק בית בתל אביב | ביקורת מבנים מקצועית ע"י מהנדס | אריקס ביקורת מבנים',
  ...
  'למה-דוחות-בדק-בית-מסורבלים': {
    title: 'למה דוחות בדק בית כל כך מסורבלים - ולמה אנחנו כותבים אחרת | אריקס ביקורת מבנים',
