...
export const aliasToPrimaryMap: Record<string, string> = {
  // Cities
  'home-inspection-tel-aviv': 'בדק-בית-בתל-אביב',
  'home-inspection-jerusalem': 'בדק-בית-בירושלים',
  'raanana-inspection': 'בדק-בית-ברעננה',
  'hod-hasharon-inspection': 'בדק-בית-בהוד-השרון',
  'herzliya-inspection': 'בדק-בית-בהרצליה',
  'ramat-hasharon-inspection': 'בדק-בית-ברמת-השרון',
  'shoham-inspection': 'בדק-בית-בשוהם',
  'ness-ziona-inspection': 'בדק-בית-בנס-ציונה',
  'tel-mond-inspection': 'בדק-בית-בתל-מונד',
  'even-yehuda-inspection': 'בדק-בית-באבן-יהודה',

  // Services & Inner Pages
  'about': 'אודות',
  'new-apartment-inspection': 'בדק-בית-מקבלן',
  'second-hand-inspection': 'בדק-בית-יד-שנייה',
  'villa-inspection': 'בדק-בית-לבית-פרטי-וילה',
  'warranty-inspection': 'בדק-בית-סוף-שנת-בדק',
  'leak-detection': 'איתור-נזילות-ורטיבות',
  'complex-building-defects': 'איתור-ליקויי-בנייה-מורכבים',
  'court-expert': 'חוות-דעת-הנדסית-לבית-משפט',
  'pricing': 'בדק-בית-מחיר',
  'home-inspection-price': 'בדק-בית-מחיר',
  'privacy-policy': 'מדיניות-פרטיות',
  'accessibility-statement': 'הצהרת-נגישות',
  'checklist': 'מה-אנחנו-בודקים',
  'what-we-check': 'מה-אנחנו-בודקים',
  'knowledge-hub': 'מאגר-הידע-ההנדסי',
...
const metadataMapping: Record<string, { title: string; description: string; keywords?: string[] }> = {
  'בדק-בית-בתל-אביב': {
    title: 'בדק בית בתל אביב | ביקורת מבנים מקצועית ע"י מהנדס',
    description: 'צריכים בדק בית בתל אביב? אריקס ביקורת מבנים מציעה שירות בדק בית מקיף ואיתור ליקויים בתל אביב והמרכז ע"י מהנדסי בניין מוסמכים (B.Sc) וציוד טכנולוגי מתקדם.',
    keywords: ['בדק בית בתל אביב', 'ביקורת מבנים בתל אביב', 'מהנדס בדק בית בתל אביב', 'בדק בית תמ"א 38', 'איתור נזילות בתל אביב']
  },
  'home-inspection-tel-aviv': {
    title: 'בדק בית בתל אביב | ביקורת מבנים מקצועית ע"י מהנדס',
    description: 'צריכים בדק בית בתל אביב? אריקס ביקורת מבנים מציעה שירות בדק בית מקיף ואיתור ליקויים בתל אביב והמרכז ע"י מהנדסי בניין מוסמכים (B.Sc) וציוד טכנולוגי מתקדם.',
  },
  'בדק-בית-בירושלים': {
    title: 'בדק בית בירושלים | מהנדס מוסמך',
  ...
  'אודות': {
    title: 'אודות | ניסיון ומקצועיות בביקורת מבנים',
  ...
  'בדק-בית-מקבלן': {
    title: 'בדק בית מקבלן | בדיקת דירה חדשה לפני מסירה',
  ...
  'בדק-בית-יד-שנייה': {
    title: 'בדק בית יד שנייה | בדיקת דירה לפני קנייה',
  ...
  'בדק-בית-לבית-פרטי-וילה': {
    title: 'בדק בית לבית פרטי או וילה | ביקורת מבנים מקיפה',
  ...
  'איתור-נזילות-ורטיבות': {
    title: 'איתור נזילות ורטיבות במצלמה תרמית | איתור נזילות מומחה',
  ...
  'איתור-ליקויי-בנייה-מורכבים': {
    title: 'איתור ליקויי בנייה הנדסיים מורכבים (ת"י 1920)',
  ...
  'בדק-בית-תמא-38-פינוי-בינוי': {
    title: 'בדק בית תמ"א 38 ופינוי בינוי | מהנדס מוסמך',
  ...
  'למה-דוחות-בדק-בית-מסורבלים': {
    title: 'למה דוחות בדק בית כל כך מסורבלים - ולמה אנחנו כותבים אחרת',
    description: '95% מדוחות בדק הבית בישראל כתובים כחוות דעת משפטית לקרב שטרם התחיל. גלו למה זה קורה, למה זה מזיק דווקא לרוכש הדירה, ואיך אריקס ביקורת מבנים כותבת דוחות שבאמת עוזרים לתקן ליקויים.',
    keywords: ['דוח בדק בית מסורבל', 'דוח בדק בית מנופח', 'חוות דעת הנדסית', 'אינג יוסי פרי', 'אריקס ביקורת מבנים', 'תיקון ליקויי בנייה']
  },
  'cumbersome-inspection-reports': {
    title: 'למה דוחות בדק בית כל כך מסורבלים - ולמה אנחנו כותבים אחרת',
    description: '95% מדוחות בדק הבית בישראל כתובים כחוות דעת משפטית לקרב שטרם התחיל. גלו למה זה קורה, למה זה מזיק דווקא לרוכש הדירה, ואיך אריקס ביקורת מבנים כותבת דוחות שבאמת עוזרים לתקן ליקויים.',
  },
  'חוות-דעת-הנדסית-לבית-משפט': {
    title: 'חוות דעת הנדסית לבית משפט | מהנדס מומחה קביל משפטית',
  ...
  'בדק-בית-מחיר': {
    title: 'כמה עולה בדק בית? מחירון בדק בית מעודכן 2026',
  ...
  'אישור-מהנדס-לפרגולה': {
    title: 'אישור מהנדס לפרגולה - אישור קונסטרוקטור מוסמך (תיקון 101)',
  ...
  'מאגר-הידע-ההנדסי': {
    title: 'מאגר הידע ההנדסי | מדריכים ומאמרים בבדק בית',
  ...
  'what-we-check': {
    title: 'רשימת תיוג לבדק בית (מה אנחנו בודקים?)',
...
function formatTitle(rawTitle: string): string {
  if (!rawTitle) return "אריקס ביקורת מבנים";

  const BRAND = "אריקס ביקורת מבנים";
  let clean = rawTitle.trim();

  // Strip trailing occurrences of brand name or variations like '| אריקס ביקורת מבנים', '- אריקס', '| אריקס', etc.
  let prev = '';
  while (clean !== prev) {
    prev = clean;
    clean = clean
      .replace(/\s*[\|-]\s*(?:אריקס(?:\s+ביקורת\s+מבנים)?)\s*$/gi, '')
      .replace(/\s*[\|-]\s*$/gi, '')
      .trim();
  }

  if (clean.endsWith(BRAND)) {
    clean = clean.slice(0, -BRAND.length).trim();
...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  // 0. Check if alias -> redirect canonical
  const aliasKeys = Object.keys(aliasToPrimaryMap);
  const foundAliasKey = aliasKeys.find(ak => {
    const norm = ak.normalize('NFC').toLowerCase();
    return norm === decodedSlug || encodeURIComponent(norm).toLowerCase() === decodedSlug;
  });

  if (foundAliasKey) {
    const primarySlug = aliasToPrimaryMap[foundAliasKey];
    const encodedPrimary = encodeURIComponent(primarySlug);

    const primaryMeta = metadataMapping[primarySlug];
    if (primaryMeta) {
      const formattedTitle = formatTitle(primaryMeta.title);
      return {
        title: formattedTitle,
        description: primaryMeta.description,
        keywords: primaryMeta.keywords || [],
        alternates: {
          canonical: `/${encodedPrimary}`,
        },
        openGraph: {
          title: formattedTitle,
          description: primaryMeta.description,
          url: `https://www.homeinspection.co.il/${encodedPrimary}`,
          locale: "he_IL",
          type: "website",
        }
      };
    ...
    if (locationMapping[primarySlug]) {
      const city = locationMapping[primarySlug];
      const cityTitle = formatTitle(`בדק בית ב${city} | ביקורת מבנים מקצועית ע"י מהנדס`);
  ...
  if (foundMapKey) {
    ...
    const formattedTitle = formatTitle(matched.title);
    return {
      title: formattedTitle,
  ...
  if (article) {
    const title = formatTitle(article.title);
...
export default async function Page({ params }: { params: Promise<{ slug: string }> }) {
  ...
  // Check if requested slug is an alias -> Redirect immediately to primary Hebrew route
  const aliasKeys = Object.keys(aliasToPrimaryMap);
  const foundAliasKey = aliasKeys.find(ak => {
    const norm = ak.normalize('NFC').toLowerCase();
    const target = decodedSlug.toLowerCase();
    return norm === target || encodeURIComponent(norm).toLowerCase() === target;
  });

  if (foundAliasKey) {
    const primarySlug = aliasToPrimaryMap[foundAliasKey];
    redirect(`/${encodeURIComponent(primarySlug)}`);
  }
